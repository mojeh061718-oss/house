...
import {
  ...
  solid, tex, metal, chrome, glass, mirror, artMaterial, foliage
} from './builders.js';
...
export const ITEMS = [
  ...
  },
  {
    ...
    build: (p) => {
      const g = G();
      const wood = solid(p.wood, 0.5);
      box(g, wood, 110, 4, 60, 0, 40, 0, { r: 1.2 });
      box(g, wood, 100, 3, 50, 0, 14, 0);
  ...
  },
  {
    ...
    build: (p) => {
      const g = G();
      cyl(g, solid(p.wood, 0.5), 22.5, 3, 0, 52, 0);
  ...
  },
  {
    ...
    build: (p) => {
      const g = G();
      const wood = solid(p.wood, 0.55);
      box(g, wood, 160, 40, 42, 0, 12, 0, { r: 1.5 });
  ...
  },
  {
    ...
    build: (p) => {
      const g = G();
      const wood = solid(p.wood, 0.6);
      box(g, wood, 90, 200, 30, 0, 0, 0);
  ...
  },
  {
    ...
    build: (p) => {
      ...
      box(g, wood, 46, 44, 40, 0, 12, 0, { r: 1.5 });
      box(g, solid(p.wood, 0.45), 40, 16, 1.5, 0, 34, 20.2);
      box(g, solid(p.wood, 0.45), 40, 16, 1.5, 0, 15, 20.2);
      knob(g, 0, 42, 21.5);
      knob(g, 0, 23, 21.5);
      return g;
    }
  },
  {
    ...
    build: (p) => {
      const g = G();
      const wood = solid(p.wood, 0.55);
      box(g, wood, 152, 214, 62, 0, 0, 0, { r: 1 });
      box(g, solid(p.wood, 0.42), 72, 204, 2, -38, 4, 30.5);
      box(g, solid(p.wood, 0.42), 72, 204, 2, 38, 4, 30.5);
      box(g, wood, 152, 8, 62, 0, 214, 0);
  ...
  },
  {
    ...
    build: (p) => {
      ...
      box(g, wood, 122, 74, 50, 0, 10, 0, { r: 1.5 });
      for (let r = 0; r < 3; r++) {
        const y = 16 + r * 23;
        box(g, solid(p.wood, 0.42), 112, 19, 1.5, 0, y, 25.2);
  ...
  // ======================= KITCHEN =======================
  {
    ...
    build: (p) => {
      ...
      box(g, solid(p.wood, 0.5), 60, 76, 58, 0, 10, -2, { r: 0.8 });
      box(g, solid(p.wood, 0.42), 54, 70, 1.6, 0, 12, 27.5);
  ...
  },
  {
    ...
    build: (p) => {
      ...
      box(g, solid(p.wood, 0.5), 80, 76, 58, 0, 10, -2, { r: 0.8 });
      box(g, solid(p.wood, 0.42), 36, 70, 1.6, -20, 12, 27.5);
      box(g, solid(p.wood, 0.42), 36, 70, 1.6, 20, 12, 27.5);
  ...
  },
  {
    ...
    build: (p) => {
      const g = G();
      box(g, solid(p.wood, 0.5), 80, 72, 36, 0, 0, 0, { r: 0.8 });
      box(g, solid(p.wood, 0.42), 37, 66, 1.6, -19.5, 3, 18.5);
      box(g, solid(p.wood, 0.42), 37, 66, 1.6, 19.5, 3, 18.5);
  ...
  },
  {
    ...
    build: (p) => {
      const g = G();
      box(g, solid(p.wood, 0.5), 176, 84, 84, 0, 2, 0, { r: 1 });
      for (let i = -1; i <= 1; i++) {
        box(g, solid(p.wood, 0.42), 52, 78, 1.6, i * 57, 5, 42.8);
  ...
  },
  {
    ...
    build: (p) => {
      const g = G();
      cyl(g, solid(p.wood, 0.5), 17, 5, 0, 71, 0, { seg: 28 });
      for (let i = 0; i < 4; i++) {
  ...
  },
  {
    ...
    build: (p) => {
      ...
      box(g, solid(p.wood, 0.5), 82, 62, 48, 0, 12, 0, { r: 1 });
      box(g, solid(p.wood, 0.42), 76, 27, 1.5, 0, 16, 24.2);
      box(g, solid(p.wood, 0.42), 76, 27, 1.5, 0, 45, 24.2);
  ...
  // ======================= DINING =======================
  {
    ...
    build: (p) => {
      const g = G();
      box(g, solid(p.wood, 0.45), 182, 5, 92, 0, 71, 0, { r: 1.2 });
      legs4(g, solid(p.wood, 0.5), 168, 80, 71, 3.2, 8, true);
      return g;
    }
  },
  {
    ...
    build: (p) => {
      const g = G();
      cyl(g, solid(p.wood, 0.45), 62, 5, 0, 71, 0, { seg: 40 });
      cyl(g, solid(p.wood, 0.5), 5, 66, 0, 4, 0);
      cyl(g, solid(p.wood, 0.5), 24, 4, 0, 0, 0, { seg: 32 });
      return g;
    }
  },
  {
    ...
    build: (p) => {
      const g = G();
      const wood = solid(p.wood, 0.55);
      box(g, wood, 44, 4, 44, 0, 44, 2, { r: 1.5 });
      box(g, solid('#c8bca4', 0.9), 40, 4, 40, 0, 48, 2, { r: 2 });
      legs4(g, wood, 40, 42, 44, 1.8, 3);
      const back = box(g, wood, 42, 46, 3, 0, 46, -20);
  ...
  // ======================= OFFICE =======================
  {
    ...
    build: (p) => {
      const g = G();
      box(g, solid(p.wood, 0.5), 142, 4, 70, 0, 71, 0, { r: 1 });
      box(g, solid(dark, 0.45), 4, 68, 62, -66, 2, 0);
      box(g, solid(dark, 0.45), 4, 68, 62, 66, 2, 0);
      // drawer unit
      box(g, solid(p.wood, 0.5), 38, 52, 58, 46, 18, 0, { r: 1 });
      for (let r = 0; r < 3; r++) {
        box(g, solid(p.wood, 0.42), 34, 14, 1.5, 46, 21 + r * 16, 29.5);
  ...
  },
  {
    ...
    build: (p) => {
      const g = G();
      box(g, solid(p.wood, 0.5), 92, 4, 24, 0, 0, 0, { r: 0.8 });
