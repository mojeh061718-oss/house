...
export const MATERIALS = [
  // Wood floors
  { id: 'oak', name: 'Oak', use: 'floor', gen: 'wood', scale: 240, rough: 0.62, params: { seed: 11, base: '#b58a5c', dark: '#8a6238', light: '#d9b384', planks: 6 } },
  { id: 'walnut', name: 'Walnut', use: 'floor', gen: 'wood', scale: 240, rough: 0.55, params: { seed: 23, base: '#6e4a30', dark: '#452b18', light: '#96693f', planks: 6 } },
  { id: 'ash_gray', name: 'Ash Grey', use: 'floor', gen: 'wood', scale: 240, rough: 0.66, params: { seed: 31, base: '#a89a8a', dark: '#7d7264', light: '#cfc2b0', planks: 6 } },
  { id: 'honey_pine', name: 'Honey Pine', use: 'floor', gen: 'wood', scale: 240, rough: 0.6, params: { seed: 47, base: '#c99a5f', dark: '#9c7038', light: '#e8c288', planks: 8 } },
  { id: 'parquet', name: 'Herringbone', use: 'floor', gen: 'herringbone', scale: 180, rough: 0.5, params: { seed: 13, base: '#a97e4f', dark: '#7c5a33', light: '#cfa76f' } },
  // Stone / tile floors
  { id: 'tile_white', name: 'Porcelain White', use: 'floor', gen: 'tiles', scale: 120, rough: 0.25, params: { seed: 5, count: 2, gap: 3, grout: '#b9b6ae', colors: ['#e8e6e0'], variation: 8 } },
  { id: 'tile_gray', name: 'Slate Grey', use: 'floor', gen: 'tiles', scale: 120, rough: 0.4, params: { seed: 9, count: 2, gap: 3, grout: '#77746e', colors: ['#9a978f', '#8b8880'], variation: 12 } },
  { id: 'tile_beige', name: 'Travertine', use: 'floor', gen: 'tiles', scale: 120, rough: 0.45, params: { seed: 15, count: 2, gap: 3, grout: '#a99e8c', colors: ['#d6c9b2', '#cbbda4'], variation: 10 } },
  { id: 'tile_checker', name: 'Marble Checker', use: 'floor', gen: 'tiles', scale: 120, rough: 0.2, params: { seed: 19, count: 4, gap: 2, grout: '#888888', colors: ['#e9e7e3', '#3a3c40'], checker: true, marbled: true } },
  { id: 'marble_white', name: 'Calacatta Marble', use: 'floor', gen: 'marble', scale: 260, rough: 0.15, params: { seed: 3, base: '#eceae6', tint: '#dcd8d2', vein: '#9aa0a8', sharp: 10, veinStrength: 0.8 } },
  { id: 'marble_dark', name: 'Nero Marble', use: 'floor', gen: 'marble', scale: 260, rough: 0.18, params: { seed: 8, base: '#2b2d31', tint: '#3a3d43', vein: '#c9c4ba', sharp: 12, veinStrength: 0.85 } },
  { id: 'concrete_floor', name: 'Polished Concrete', use: 'floor', gen: 'concrete', scale: 300, rough: 0.35, params: { seed: 27, base: '#a3a19c', trowel: true } },
  // Carpets
  { id: 'carpet_beige', name: 'Wool Beige', use: 'floor', gen: 'carpet', scale: 100, rough: 0.95, params: { seed: 33, base: '#cdbfa5', dark: '#a3947a' } },
  { id: 'carpet_gray', name: 'Loop Grey', use: 'floor', gen: 'carpet', scale: 100, rough: 0.95, params: { seed: 37, base: '#9c9ca0', dark: '#71716f' } },
  { id: 'carpet_navy', name: 'Plush Navy', use: 'floor', gen: 'carpet', scale: 100, rough: 0.95, params: { seed: 41, base: '#3c4a66', dark: '#252f45' } },
  { id: 'deck_wood', name: 'Deck Boards', use: 'floor', gen: 'wood', scale: 260, rough: 0.75, params: { seed: 55, base: '#8a6a4a', dark: '#5c4530', light: '#ab8a64', planks: 8 } },

  // Wall paints
  { id: 'paint_warmwhite', name: 'Warm White', use: 'wall', gen: 'paint', scale: 200, rough: 0.9, params: { base: '#ece7dd', seed: 61 } },
  { id: 'paint_offwhite', name: 'Snow', use: 'wall', gen: 'paint', scale: 200, rough: 0.9, params: { base: '#f2f2ef', seed: 62 } },
  { id: 'paint_greige', name: 'Greige', use: 'wall', gen: 'paint', scale: 200, rough: 0.9, params: { base: '#d3ccbf', seed: 63 } },
  { id: 'paint_sage', name: 'Sage', use: 'wall', gen: 'paint', scale: 200, rough: 0.9, params: { base: '#b6c2ab', seed: 64 } },
  { id: 'paint_sky', name: 'Powder Blue', use: 'wall', gen: 'paint', scale: 200, rough: 0.9, params: { base: '#b8cad6', seed: 65 } },
  { id: 'paint_terracotta', name: 'Terracotta', use: 'wall', gen: 'paint', scale: 200, rough: 0.9, params: { base: '#c07f5e', seed: 66 } },
  { id: 'paint_navy', name: 'Deep Navy', use: 'wall', gen: 'paint', scale: 200, rough: 0.9, params: { base: '#33415c', seed: 67 } },
  { id: 'paint_charcoal', name: 'Charcoal', use: 'wall', gen: 'paint', scale: 200, rough: 0.9, params: { base: '#4a4c50', seed: 68 } },
  { id: 'paint_blush', name: 'Blush', use: 'wall', gen: 'paint', scale: 200, rough: 0.9, params: { base: '#dcc3b8', seed: 69 } },
  { id: 'paint_olive', name: 'Olive', use: 'wall', gen: 'paint', scale: 200, rough: 0.9, params: { base: '#8a8a64', seed: 70 } },
  { id: 'wallpaper_stripe', name: 'Striped Paper', use: 'wall', gen: 'stripes', scale: 120, rough: 0.85, params: { base: '#e8e2d4', stripe: '#b9ccc4', count: 8, seed: 71 } },
  { id: 'wallpaper_pin', name: 'Pinstripe', use: 'wall', gen: 'stripes', scale: 80, rough: 0.85, params: { base: '#ddd6c8', stripe: '#8e9aa8', count: 16, seed: 72 } },
  { id: 'brick_red', name: 'Exposed Brick', use: 'wall', gen: 'brick', scale: 160, rough: 0.9, params: { seed: 73, rows: 8, cols: 4, gap: 3, mortar: '#b0a89a', colors: ['#9e5b45', '#8a4a38', '#a8654c', '#7c4434'] } },
  { id: 'brick_white', name: 'Painted Brick', use: 'wall', gen: 'brick', scale: 160, rough: 0.9, params: { seed: 74, rows: 8, cols: 4, gap: 3, mortar: '#c9c5bc', colors: ['#e3ded4', '#dcd6ca', '#eae5db'] } },
  { id: 'tile_subway', name: 'Subway Tile', use: 'wall', gen: 'brick', scale: 90, rough: 0.2, params: { seed: 75, rows: 8, cols: 4, gap: 2, mortar: '#9aa0a2', colors: ['#eef1f0', '#e6eae9'] } },
  { id: 'tile_bath', name: 'Bath Ceramic', use: 'wall', gen: 'tiles', scale: 100, rough: 0.2, params: { seed: 76, count: 4, gap: 2, grout: '#98a2a6', colors: ['#dfe8ea', '#d3dfe2'], variation: 6 } },
  { id: 'concrete_wall', name: 'Concrete', use: 'wall', gen: 'concrete', scale: 240, rough: 0.8, params: { seed: 77, base: '#9d9b96' } },
